...
using web_practica_ultima.Models;

namespace web_practica_ultima.Controllers
{
    public class AsignaturasAsignadasController : Controller
    {
        private readonly BdPracticaContext _context;

        public AsignaturasAsignadasController(BdPracticaContext context)
        {
            _context = context;
        }
        ...
        {
            var bdPracticaContext = _context.AsignaturasAsignadas.Include(a => a.Asignaturas).Include(a => a.Estudiantes);
            return View(await bdPracticaContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("AsignaturasId,EstudiantesId,FechaRegistro")] AsignaturasAsignada asignaturasAsignada)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AsignaturasId,EstudiantesId,FechaRegistro")] AsignaturasAsignada asignaturasAsignada)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BdPracticaContext.AsignaturasAsignadas'  is null.");
            }
            var asignaturasAsignada = await _context.AsignaturasAsignadas.FindAsync(id);
            if (asignaturasAsignada != null)
            {
